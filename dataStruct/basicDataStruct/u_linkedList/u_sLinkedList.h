...
static void sList_constructor(sList_obj_T* this_);
static void sList_constructorSize(sList_obj_T* this_, uint32_t sizeParam);
static void sList_destructor(sList_obj_T* this_);
/* Public Methods */

static pdBool sList_isEmpty(sList_obj_T* this_);
static uint32_t sList_size(sList_obj_T* this_);
static sList_iterator_T sList_begin(sList_obj_T* this_);
static sList_iterator_T sList_end(sList_obj_T* this_);
static void sList_addFront(sList_obj_T* this_);
static void sList_pushFront(sList_obj_T* this_, sList_data_T newData);
static void sList_pushBack(sList_obj_T* this_, sList_data_T newData);
static sList_data_T sList_popBack(sList_obj_T* this_);
static sList_data_T sList_popFront(sList_obj_T* this_);
static void sList_popFrontNonReturn(sList_obj_T* this_);
static sList_iterator_T sList_advance(sList_obj_T* this_, uint32_t pos);
static void sList_erase(sList_obj_T* this_, uint32_t position);
static void sList_insert(sList_obj_T* this_, uint32_t position, sList_data_T newData);
static void sList_swap(sList_obj_T* this_, uint32_t firstPos, uint32_t secondPos);
static void sList_sortAscending(sList_obj_T* this_);
static void sList_sortDescending(sList_obj_T* this_);
static void sList_reverse(sList_obj_T* this_);
static void sList_unique(sList_obj_T* this_);

/* Overloading operator */

static pdBool sList_isTheSame(sList_obj_T* this_, sList_obj_T* otherOperand);
